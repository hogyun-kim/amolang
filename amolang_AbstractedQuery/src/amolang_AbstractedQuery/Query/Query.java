...
public class Query {
	...
	public Query create_table(String table_identifier, ColumnType... column_types) {
	...
	public Query add_column(ColumnType column_type) {
	...
	public Query add_auto_increment(ColumnType column_type) {
	...
	public Query handshake_auto_increment(int constant_integer_type) {
